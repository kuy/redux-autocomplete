...
var Autocomplete = (function (_Component) {
  ...
  _createClass(Autocomplete, [{
    ...
    value: function exportProps() {
      ...
      return { staticItems: staticItems, getItemValue: getItemValue, shouldItemRender: shouldItemRender, sortItems: sortItems };
    }
  }, {
    ...
    value: function selectItemFromMouse(item, index) {
      ...
      this.props.dispatch(actions.selectItem({ index: index, props: this.exportProps() }));
