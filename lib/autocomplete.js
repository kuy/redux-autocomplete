...
var Autocomplete = (function (_Component) {
  ...
  _createClass(Autocomplete, [{
    ...
    key: 'getFuncSet',
    value: function getFuncSet() {
      var _props = this.props;
      var getItems = _props.getItems;
      var getItemValue = _props.getItemValue;
      var shouldItemRender = _props.shouldItemRender;
      var sortItems = _props.sortItems;

      return { getItems: getItems, getItemValue: getItemValue, shouldItemRender: shouldItemRender, sortItems: sortItems };
    }
  }, {
    ...
    value: function maybeScrollItemIntoView() {
      if (this.props.isOpen === true && this.props.highlightedIndex !== null) {
        ...
        (0, _domScrollIntoView2.default)(itemNode, menuNode, { onlyScrollIfNeeded: true });
      }
    }
  }, {
    key: 'handleKeyDown',
    ...
    value: function selectItemFromMouse(item, index) {
      ...
      this.props.dispatch(actions.selectItem({ index: index, fn: this.getFuncSet() }));
...
Autocomplete.propTypes = {
  ...
  getItemValue: _react.PropTypes.func,
  getItems: _react.PropTypes.func.isRequired,
...
Autocomplete.keyDownHandlers = {
  ArrowDown: function ArrowDown(event) {
    ...
    var highlightedIndex = _props3.highlightedIndex;
